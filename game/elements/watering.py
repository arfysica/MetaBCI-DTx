...
# 浇水壶
class wateringWidget(sequenceFrameObject):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.sqFrame.setGameObject(resEnum.Watering)
    ...
    def init(self):
        self.setPixmap(QPixmap(':/resources/framesequence/Watering/0.png'))
